                    ...
                    <section>
                        <div class="row" >
                            ...
                            <div class="col-8" style="margin-top: 20px; margin-bottom: 20px;" >
                                ...
                                <input type="text" id="newAnswer" class="form-control" style="height: 70px; border: 1px solid;" value="${update.ad_ansr_cont }">

                                    <span class="input-group-btn">
                                     	<button class="btn btn-default" type="button" id="QnaRegBtn" style="background-color: skyblue; color: white;">확인</button>
