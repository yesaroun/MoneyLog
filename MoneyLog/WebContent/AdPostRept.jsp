...
<script type="text/javascript">
	...
	{	
		...
		{
			alert("신고를 승인하시겠습니까? \n승인 시 해당 게시물은 계속해서 블라인드 처리됩니다.");
			
			$(location).attr("href", "adpostreptok.action?post_rept_cd=${adPostRept.post_rept_cd }&cnfm_cd=1");
			return;
		...
		$("#postReptNo-btn").click(function()
		{
			...
			alert("신고를 반려하시겠습니까? \n반려 시 해당 게시물은 다시 공개 처리됩니다.");
			
			$(location).attr("href", "adpostreptok.action?post_rept_cd=${adPostRept.post_rept_cd }&cnfm_cd=2");
			return;
                                                ...
                                                <tr>
                                                   ...
                                                   <tr>
													   ...
													   <td colspan="3"><a href="./admoneypost.action?post_cd=<fmt:formatNumber value="${adPostRept.post_cd}" type="number"/>">
													      <fmt:formatNumber value="${adPostRept.post_cd}" type="number"/></a></td>
